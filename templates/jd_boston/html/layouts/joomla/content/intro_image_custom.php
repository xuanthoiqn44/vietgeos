...
<div class="_intro-img entry-image intro-image">
	...
	<img
	<?php /*  <?php if ($images->image_intro_caption):
	...
	*/ ?>
	...
	<?php if (isset($images->image_intro_caption)){
			echo 'class="_img-caption"' . ' title="' . htmlspecialchars($images->image_intro_caption) . '"';?>
...
<?php }else{  ?>
	<?php echo 'class="_img-caption"' . ' title=""';?>
	src="<?php echo htmlspecialchars($intro_image); ?>" alt="" itemprop="thumbnailUrl"/>
<?php } ?>
