...
<?php echo $this->edit_link; ?>
 ...
 col-sm-12
 col-xs-12">
    <div class="bd-layoutcolumn-9 bd-column" ><div class="bd-vertical-align-wrapper"><h2 class=" bd-productoverviewtitle-1">
...
<?php endif ?></div></div>
 ...
 col-sm-12
 col-xs-12">
    <div class="bd-layoutcolumn-22 bd-column" ><div class="bd-vertical-align-wrapper"><?php if (isset($productItems->productPrice)) : ?>
...
<div class=" bd-pricetext-10">
    ...
    <span class=" bd-container-97 bd-tagstyles bd-bootstrap-btn bd-btn-primary basePrice">
...
<div class=" bd-pricetext-9">
    ...
    <span class=" bd-container-96 bd-tagstyles bd-bootstrap-btn bd-btn-primary salesPrice">
...
<form method="post" class="product" action="<?php echo JRoute::_ ('index.php'); ?>">
    <?php
        ...
        $buttonDataAttrs = '';
        $classNames = ' bd-productbuy-3 bd-button-177';
    ?>
...
<div class=" bd-tabinformationcontrol-2 tabbable" data-responsive="true">
    ...
    <div class=" bd-container-98 bd-tagstyles bd-bootstrap-btn bd-btn-primary tab-content">
    ...
    <div class=" bd-container-43 bd-tagstyles bd-bootstrap-btn bd-btn-primary accordion-content"></div>
</div>
    </div>
</div>
<?php echo $jsContent; ?>
