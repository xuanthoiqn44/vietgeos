...
jQuery(function($) {
    ...
    var activeLayoutType = $.cookie('layoutType') || 'grid',
        activeLayoutTypeSelector = $.cookie('layoutSelector') || '.separated-item-18.grid';
    ...
    var layoutTypes = [];
        ...
        layoutTypes.push({
            ...
            iconUrl: '',
            iconDataId: '2694525',
            iconClassNames: 'bd-icon-93 bd-no-margins'
        });
        layoutTypes.push({
            name:'bd-griditemlist',
            iconUrl: '',
            iconDataId: '2694537',
            iconClassNames: 'bd-icon-96'
        });
    if (typeof window.buildTypeSelector === 'function') {
        ...
        $(document).on('click', '.bd-products i[data-layout-name="bd-griditemgrid"]', function (e) {
            if (activeLayoutType !== 'grid') {
                var grid = $('.bd-grid-17');
                grid.find('.separated-item-18.grid').css('display', 'block');
                grid.find(activeLayoutTypeSelector).css('display', 'none');
                activeLayoutType = 'grid';
                activeLayoutTypeSelector = '.separated-item-18.grid';
        ...
        $(document).on('click', '.bd-products i[data-layout-name="bd-griditemlist"]', function (e) {
            if (activeLayoutType !== 'list') {
                var grid = $('.bd-grid-17');
                grid.find('.separated-item-19.list').css('display', 'block');
                grid.find(activeLayoutTypeSelector).css('display', 'none');
                activeLayoutType = 'list';
                activeLayoutTypeSelector = '.separated-item-19.list';
...
jQuery(function ($) {
    ...
    $('.bd-productsslider-1').each(function () {
        ...
        leftButton.find('.bd-carousel-26').click(function() {
            slider.carousel('prev');
            return false;
        }).attr('href', '#');

        rightButton.find('.bd-carousel-26').click(function() {
            slider.carousel('next');
            return false;
        }).attr('href', '#');
