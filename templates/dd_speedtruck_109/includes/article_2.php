...
<?php
    ...
    ?>
<div class=" bd-postimage-1 bd-no-margins <?php echo $floatClass; ?>">
    
    <?php if ($caption): ?>
    <div class=" bd-container-50 bd-tagstyles bd-bootstrap-btn bd-btn-primary ">
        <?php echo $caption; ?>
    </div>
    <?php endif; ?>
...
?>
<div class=" bd-postcontent-2 bd-tagstyles bd-custom-blockquotes bd-bootstrap-btn bd-btn-primary bd-contentlayout-offset" <?php echo $attr; ?> itemprop="articleBody">
...
<a class="bd-postreadmore-2 bd-button-119 " href="<?php echo $data['readmore-link'] ?>" >
