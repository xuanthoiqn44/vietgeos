...
$megamenuClass = '';
$megamenuSubCatItemClass = 'bd-sub-item bd-mega-item  bd-menuitem-75';
...
ob_start();
?>
<div class="bd-menuitem-73 bd-sub-item bd-mega-item  bd-menuitem-74 separated-item-15">
...
ob_start();
?>
<li class=" bd-menuitem-72 bd-toplevel-item {submenu_icon_only}">
<?php 
...
ob_start();
?>
<li class=" bd-menuitem-73 bd-sub-item">
