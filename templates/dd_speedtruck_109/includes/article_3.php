...
<div class=" bd-postimage-3 bd-no-margins <?php echo $floatClass; ?>">
    ...
    <?php if ($caption): ?>
    <div class=" bd-container-54 bd-tagstyles bd-bootstrap-btn bd-btn-primary ">
        <?php echo $caption; ?>
    </div>
    <?php endif; ?>
</div>
...
?>
<div class=" bd-postcontent-3 bd-tagstyles bd-bootstrap-btn bd-btn-primary bd-contentlayout-offset" <?php echo $attr; ?> itemprop="articleBody">
