...
<body class=" bootstrap bd-body-2  bd-pagebackground-322 bd-margins">
    <div data-affix
     data-offset=""
...
<?php if (isset($slideshow_close_section)) if ($slideshow_close_section == 2) { ?><?php include("$themeDir/site/slideshow.php"); ?><?php } ?>
...
?>
		...
		<?php if (isset($design_close_section)) if ($design_close_section == 1 ) { ?><?php include("$themeDir/site/design.php"); ?><?php } ?>
</footer>
