...
<?php if ($slideshow_close_section == 1 | $slideshow_close_section == 2) { ?><?php include("$themeDir/site/slideshow.php"); ?><?php } ?>

<section class=" bd-section-7 bd-tagstyles bd-bootstrap-btn bd-btn-primary" id="blank-1_module" data-section-title="blank1_module">
  <div class="bd-container-inner bd-margins clearfix">
        <?php
